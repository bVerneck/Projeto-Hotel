...
<rect fill="white" height="38.1" width="80"></rect>
  ...
  <div class="credit-card-info--form">
    <div class="input_container">
      ...
      <input id="password_field" class="input_field" type="text" name="input-name" title="Inpit title" placeholder="
Escreva seu nome completo">
    ...
    <button class="purchase--btn">Confirmar</button>
</form>
</div>
</template>
...
.purchase--btn {
  ...
  font-size: 13px;
  font-weight: 700;
  background: linear-gradient(180deg, #670bff, #670bff 50%, #670bff 100%);
